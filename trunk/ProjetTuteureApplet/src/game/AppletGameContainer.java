...
/**
 * Classe qui surpasse la AppletGameContainer de base,
 * pour qu'on puisse faire un getGame() afin de
 * pouvoir utiliser des fonctions javascript
 */
public class AppletGameContainer extends Applet {
	private static final long serialVersionUID = -6092795514598226349L;
...
/**
   ...
   public class ConsolePanel extends Panel {
	private static final long serialVersionUID = 3130635694062544512L;
...
public void init() {
      ...
      try {
         ...
         displayParent = new Canvas() {
			private static final long serialVersionUID = -7717457190359946479L;
			@Override
